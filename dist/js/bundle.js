...
function Calc() {
  ...
  function initLocalInfo(parent, activeClass, info) {
    ...
    offActiveClass(elements, activeClass); // используем функцию, котрая отключает активность 
  ...
  getStaticInfo('.calculating__choose_big', 'calculating__choose-item_active'); // вызываем функцию на каждую формму статичной инфы, котрая обрабатывает дефствия пользователя 
  ...
  getDynamicInfo('#age'); // вызвыаем функию на каждый инпут и работаем с ней 
}
...
function Cards() {
  // CLASS
  var kards = document.querySelectorAll('.menu__item');
  kards.forEach(function (i) {
    return i.remove();
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              throw new Error("\u041D\u0435 \u043F\u043E\u043B\u0443\u0447\u0430\u0435\u0442\u0441\u044F \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u0442\u044C \u0437\u0430\u043F\u0440\u043E\u0441 \u043D\u0430 \u0441\u0435\u0440\u0432\u0435\u0440 ".concat(url, ", \u0441\u0442\u0430\u0441\u0442\u0443\u0441 \u043E\u0448\u0438\u0431\u043A\u0438 - ").concat(res.status));
  ...
  var NewCard = /*#__PURE__*/function () {
    function NewCard(src, alt, title, content, price, parentSelector) {
    ...
    _createClass(NewCard, [{
      ...
      key: "verst",
      value: function verst() {
        var element = document.createElement('div');
        element.innerHTML = "\n            <img class = 'myimg' src=".concat(this.src, " alt=").concat(this.alt, ">\n            <h3 class=\"menu__item-subtitle\">").concat(this.title, "</h3>\n            <div class=\"menu__item-descr\">").concat(this.content, "</div>\n            <div class=\"menu__item-divider\"></div>\n            <div class=\"menu__item-price\">\n                <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                <div class=\"menu__item-total\"><span>").concat(this.price, "</span> \u0431\u0435\u0434 \u0440\u0443\u0431</div>\n            </div>");
        ...
        if (this.rest.length === 0) {
          ...
          this.rest.forEach(function (className) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "hideM": () => (/* binding */ hideM),
/* harmony export */   "showM": () => (/* binding */ showM),
...
var timerId = setTimeout(function () {
  showM('.modal');
}, 150000); // таймер если проходит 150 сек то показываем модельно окно
...
function Modal(modalSelector, triggerSelector) {
  var buttonShowModal = document.querySelectorAll(triggerSelector),
  ...
  buttonShowModal.forEach(function (i) {
...
/* harmony import */ var _Modal__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./Modal */ "./src/js/Modal.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function Post() {
  ...
  function showThanksModal(message) {
    ...
    (0,_Modal__WEBPACK_IMPORTED_MODULE_24__.showM)('.modal');
    ...
    setTimeout(function () {
      ...
      (0,_Modal__WEBPACK_IMPORTED_MODULE_24__.hideM)('.modal');
    }, 5000);
  ...
  function sendDataForm(form) {
    form.addEventListener('submit', function (e) {
      ...
      form.insertAdjacentElement('afterend', statusMessage); // метод insertAdjacentElement() позволяет болле точно определять(выбирать) место расположеня элемента

      var dataForm = new FormData(form); // собираем данные

      var json = JSON.stringify(Object.fromEntries(dataForm.entries())); // работаем с форматами 
...
function Slider() {
  var butPrev = document.querySelector('.offer__slider-prev'),
  ...
  if (sliderImg.length < 10) {
    total.textContent = (0,_Timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(sliderImg.length);
    current.textContent = (0,_Timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(index);
  } else {
  ...
  sliderField.style.width = 100 * sliderImg.length + '%'; // cначала делаем так чтоб в одну строку помещались наши 4 слайда

  sliderField.style.display = 'flex'; // назачаем вторично обертке 
  // способность гибкого элемента растягиваться или сжиматься
  // для заполнения собой доступного свободного пространства

  sliderField.style.transition = '0.5s all'; // ебу что это значит 
  ...
  slider.style.position = 'relative'; // все абсолютно спозиционриванные элементы внутри будут норсально отображаться
  // точки 

  var pointsWrapper = document.createElement('ol');
  ...
  butPrev.addEventListener('click', function (event) {
    event.preventDefault();
...
function Tabs() {
  ...
  noneTabsContent(); // функция, которая перебирает контент табов, навешивает скласс hide то есть скрывает 
...
function Timer() {
  var deadline = new Date('2022-09-20');
  ...
  function setClock(selector, endtime) {
    ...
    function upperTime() {
      var func = getTimeRemaining(endtime);
...
/* harmony import */ var _Post_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Post.js */ "./src/js/Post.js");
/* harmony import */ var _Slider_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Slider.js */ "./src/js/Slider.js");
/* harmony import */ var _Calc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Calc.js */ "./src/js/Calc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  (0,_Tabs_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_Timer_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_Modal_js__WEBPACK_IMPORTED_MODULE_2__["default"])('.modal', '[data-modal]');
  (0,_Cards_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_Post_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
